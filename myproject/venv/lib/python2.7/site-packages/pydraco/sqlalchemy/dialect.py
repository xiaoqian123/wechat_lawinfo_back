...
from .exceptions import TimezoneUnawareException
...
class DracoDialect(default.DefaultDialect):
    driver = 'dracodb'
    ...
    def __init__(self, *args, **kwargs):
        super(DracoDialect, self).__init__(*args, **kwargs)
    ...
    def connect(self, host=None, port=None, *args, **kwargs):
        ...
        return self.dbapi.connect(host=host, port=port, user=user, *args, **kwargs)
